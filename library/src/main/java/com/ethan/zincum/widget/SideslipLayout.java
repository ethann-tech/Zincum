...
public class SideslipLayout extends ViewGroup {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mSlideSlop = (int) typedArray.getDimension(R.styleable.SideslipLayout_sl_slideSlop,
                TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 45, getResources().getDisplayMetrics()));
        mDuration = typedArray.getInteger(R.styleable.SideslipLayout_sl_duration, 250);
        mIsEnable = typedArray.getBoolean(R.styleable.SideslipLayout_sl_enable, true);
        typedArray.recycle();
    }
    ...
    public abstract static class OnStateChangeListener {
         ...
         */
        public boolean onInterceptTouchEvent(SideslipLayout layout) {
            return false;
        }

        public abstract void onStateChanged(SideslipLayout layout, boolean open);
    }
